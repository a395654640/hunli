...
$type=$_GET['type'];
$query="select count(*) from info where type= '{$type}'";
//设置每页显示多少条
$PageSize = 9;
...
$sql="select * from info where type= '{$type}'  order by paixu desc, id desc limit ".($page-1)*$PageSize.",".$PageSize;//注意limit后边有一空格。
